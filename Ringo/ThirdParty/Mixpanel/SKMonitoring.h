...
@class    SKMonitoringIdentity;
@protocol SKMonitoringDelegate;
...
/*!
 ...
 Library Guide</a>.
 */
@interface SKMonitoring : NSObject
 ...
 */
@property(atomic,readonly,retain) SKMonitoringIdentity *people;
 ...
 */
@property(atomic,assign) id<SKMonitoringDelegate> delegate; // allows fine grain control over uploading (optional)
...
/*!
 ...
 People</b>.
 */
@interface SKMonitoringIdentity : NSObject
...
/*!
 ...
 your code.
 */
@protocol SKMonitoringDelegate <NSObject>
@optional
 ...
 */
- (BOOL)mixpanelWillFlush:(SKMonitoring *)mixpanel;
