...
+ (NSData *)mp_dataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = SKMP_NewBase64Decode([data bytes], [data length], &outputLength);
...
+(NSString*)mp_base64EncodedStringWithData:(NSData *)data
{
    size_t outputLength = 0;
	char *outputBuffer =
    SKMP_NewBase64Encode([data bytes], [data length], false, &outputLength);
